...
from app.application.services.image_service import CreateImage
from app.application.services.role_service import RoleService
from app.application.services.specification_service import SpecificationService
from app.application.services.user_service import UserService
from app.application.services.user_roles_service import UserRolesService
...
def get_category_service(repo = Depends(get_category_repository)):
    return CategoryService(repo)

def get_product_service(repo = Depends(get_product_repository)):
    return ProductService(repo)

def get_license_service(repo = Depends(get_license_repository)):
    return LicenseService(repo)

def get_role_service(repo = Depends(get_role_repository)):
    return RoleService(repo)

def get_specification_service(repo = Depends(get_specification_repository)):
